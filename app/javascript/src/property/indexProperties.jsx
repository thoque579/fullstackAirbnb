...
class IndexProperties extends React.Component {
  ...
  render() {
    ...
    const {authenticated, property, loading } = this.state;

    if (loading) {
      return (
        <div className = "d-flex">
          <h1 className = "text-white loading-screen">Loading...</h1>
        </div>
      )
    }
                  ...
                  <div className="col-12 col-lg-9">
                    <div className="card mb-3">
                      ...
                      <div className="card-body">
                        ...
                        <p className="text-muted">
                          <small>{item.city}</small>, <small>{item.country}</small>
                        </p>
                        ...
                        <div className="container d-flex flex-wrap">
                          <div className="row">
                            <div className="col-6">
                              <p className="card-text text-unwrap"><BsPeople/> {item.max_guests} guests maximum</p>
                            </div>
                            <div className="col-6">
                              <p className="card-text"><FaBath/> {item.baths} bathrooms</p>
                            </div>
                            <div className="col-6">
                              <p className="card-text"><MdBedroomParent/> {item.bedrooms} bedrooms</p>
                            </div>
                            <div className="col-6">
                              <p className="card-text"><FaBed/> {item.beds} beds</p>
                            </div>
                          </div>
                        </div>
                      </div>
